// Enhanced Durbar Lounge Booking UI with Top-Notch Design
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:intl/intl.dart';
import 'package:url_launcher/url_launcher.dart';

class Durbarlounge extends StatefulWidget {
  const Durbarlounge({super.key});

  @override
  State<Durbarlounge> createState() => _DurbarLoungeState();
}

class _DurbarLoungeState extends State<Durbarlounge> {
  ...
  final List<Map<String, dynamic>> tables = [
    {"name": "Table A", "capacity": 4, "price": 5000},
    {"name": "Table B", "capacity": 6, "price": 4000},
  ];
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  image: AssetImage('assets/images/durbar.jpeg'),
              ...
              children: [
                ...
                _infoTile(Icons.info_outline, "About", "Details", () {
                  showDialog(
                    context: context,
                    builder: (_) => AlertDialog(
                      title: const Text("About Durbar Lounge"),
                      content: const Text(
